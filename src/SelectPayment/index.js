...
import '../Screens/PaymentCompStage/index';
...
renderSepaForm = () => (
  ...
  <div className="form-group">
    ...
    onChange={this.handleChange} />
    <div className="invalid-feedback">{this.state.formErrors.sepaName}</div>
  </div>
  ...
  <div className="form-group">
    ...
    onChange={this.handleChange} />
    <div className="invalid-feedback">{this.state.formErrors.sepaIban}</div>
  </div>
</form>
)
  ...
  render() {
    ...
    return (
      ...
      <div>
          ...
          <Button onClick={this.handleSubmit} intent="success" disabled={!this.state.submitCards || !this.state.submitSepa }>Sign up</Button>
      </div>
      </div>
    )
  }
